...
// function to add a residency in the fav list of the user
...
export const toFav = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        if (user.favResidenciesID.includes(rid)) {
            ...
            res.send({ message: "Removed residency from favorites", user: updateUser })
        } else {
...
// function to display all the favorite residencies
